...
<%@ include file="../module/navigation.jsp" %>
	<div id="app">
		<div id="main">
			...
			<section class="section">
				<div class="card">
				<c:url var="jobListUrl" value="/job_list" />
						...
						<div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
							...
							<div class="dataTable-container">
								<table class="table table-hover dataTable-table" id="jobTable">
									...
									<tbody>
										 <c:forEach items="${empJobData}" var="empJob"> 
										<tr>
											<th>${empJob.empObj.empId}</th>
											<th>${empJob.empObj.empNm}</th>
											<th>${empJob.jobName}</th>
										</tr>
										</c:forEach>
									</tbody>
								</table>
	...
	<script type="text/javascript">
        ...
        let dataTable = new simpleDatatables.DataTable(jobTable);
