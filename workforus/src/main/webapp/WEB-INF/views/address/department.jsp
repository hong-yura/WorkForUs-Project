...
<head>
    <meta charset="UTF-8">
    <title>workforus - Department Address</title>
...
<body>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Department Address</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                            ...
                            <div class="dataTable-container">
                                <table class="table table-hover" id="deptAddrTable">
    ...
    <script src="${staticUrl}/js/pages/address/department.js"></script>
